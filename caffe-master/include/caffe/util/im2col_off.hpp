#ifndef _CAFFE_UTIL_IM2COL_OFF_HPP_
#define _CAFFE_UTIL_IM2COL_OFF_HPP_
//weijie #13
...
void im2col_cpu(const Dtype* data_im, const int channels,
    ...
    const int stride_w, const int dilation_h, const int dilation_w, Dtype* data_col, const Dtype* offset);
